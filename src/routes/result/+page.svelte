<script lang="ts">
	import BigCard from '$lib/components/card/BigCard/BigCard.svelte';
	import random3Number from '$lib/utils/random-3-number';

	const [num1, num2, num3]: number[] = random3Number();
